...
######## Software Manager Menu ##############################
	def Qsoftware(self):
		...
		if not model.startswith('az') and not model in ('dm500hd', 'dm500hdv2', 'dm520', 'dm800', 'dm800se', 'dm800sev2', 'dm820', 'dm7020hd', 'dm7020hdv2', 'dm7080', 'dm8000', 'sf8008', 'ustym4kpro', 'viper4k', 'pulse4k', 'pulse4kmini') and not getBrandOEM().startswith('cube') and not getBrandOEM().startswith('wetek') and not model.startswith('alien'):
